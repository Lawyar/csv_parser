...
TEST(StrCell_Test, CheckPlusEqNCNC) {
    std::string initVal1 = "12900."s;
    const std::string initVal2 = "6900."s;
    StrCell nC1(initVal1);
    StrCell nC2(initVal2);
    nC1 += nC2;
    EXPECT_TRUE(nC1 == initVal1.append(initVal2));
}

TEST(StrCell_Test, CheckPlusNCNC) {
    std::string initVal1 = "12900."s;
    const std::string initVal2 = "6900."s;
    StrCell nC1(initVal1);
    StrCell nC2(initVal2);
